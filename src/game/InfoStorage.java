...
public class InfoStorage implements Serializable {
    ...
    private int[][] g3Coords;
    private int[][] g4Coords;
    ...
    private int[] g3Choices;
    private int[] g4Choices;
    ...
    public InfoStorage(int MAXMOVES) {
        ...
        g3Coords = new int [MAXMOVES][2];
        g4Coords = new int [MAXMOVES][2];
        ...
        g3Choices = new int[MAXMOVES];
        g4Choices = new int[MAXMOVES];

        pFits = new int[MAXMOVES];
        g1Fits = new int[MAXMOVES];
        g2Fits = new int[MAXMOVES];
        g3Fits = new int[MAXMOVES];
        g4Fits = new int[MAXMOVES];
    ...
    public void addAllCoords(int px, int py, int g1x, int g1y, int g2x, int g2y, int g3x, int g3y, int g4x, int g4y) {
        ...
        g3Coords[totalCoords][0] = g3x;
        g3Coords[totalCoords][1] = g3y;

        g4Coords[totalCoords][0] = g4x;
        g4Coords[totalCoords][1] = g4y;

        totalCoords++;
    }

    public void addAllInfo(int choice, int g1choice, int g2choice, int g3choice, int g4choice,  int dir, int fit, int g1fit, int g2fit, int g3fit, int g4fit, boolean powered) {
        choices[totalInfo] = choice;
        g1Choices[totalInfo] = g1choice;
        g2Choices[totalInfo] = g2choice;
        g3Choices[totalInfo] = g3choice;
        g4Choices[totalInfo] = g4choice;
        ...
        g3Fits[totalInfo] = g3fit;
        g4Fits[totalInfo] = g4fit;
